...
# Manually add __ssp_fail to the linker's undefined symbol list so that we link to the implementation of __ssp_fail in libstartup.a
# rather than the one in libc.a
LDFLAGS_gcc_qcc = -Wl,-Map,$@.map -Wl,--undefined=__ssp_fail
...
CCFLAGS_aarch64 += -mgeneral-regs-only -mstrict-align -fno-store-merging -fno-gcse  -fno-inline-small-functions
